...
impl Backend for CudaBackend {
    ...
    fn add(&self, _shape: &[usize], _dtype: &DataType, _a: &[f32], _b: &[f32]) -> Result<Vec<f32>, String> {
        unimplemented!("CUDA backend add is not yet implemented")
    }

    fn mul(&self, _shape: &[usize], _dtype: &DataType, _a: &[f32], _b: &[f32]) -> Result<Vec<f32>, String> {
        unimplemented!("CUDA backend mul is not yet implemented")
    }
    ...
    fn matmul(
        ...
        unimplemented!("CUDA backend matmul is not yet implemented")
    }
}
